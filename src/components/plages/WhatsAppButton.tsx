...
const WhatsAppButton: React.FC = () => {
  ...
  const message = encodeURIComponent("Bonjour, j'ai une question concernant vos services.");

  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center">
      {/* Texte qui apparaît lorsque le bouton est survolé ou cliqué sur mobile */}
      <div 
        className={`bg-white text-gray-800 py-2 px-4 rounded-lg shadow-md mr-3 transition-all duration-300 ${
